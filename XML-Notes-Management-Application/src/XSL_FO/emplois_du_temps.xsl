        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:layout-master-set>
                <fo:simple-page-master master-name="A4"
                                       page-width="400mm" page-height="250mm"
                                       margin="1cm">
                    <!-- Région principale -->
            ...
            <fo:page-sequence master-reference="A4">
                ...
                <fo:flow flow-name="xsl-region-body"  >
                    <fo:block text-align="center"  margin-bottom="10mm" font-weight="bold">
                        Emploi du temps de la semaine numéro 03 de l'année 2025
                    </fo:block>
                    <fo:block>
                        <fo:table  width="110mm" border-style="ridge" border-width="0.5pt">
                            <fo:table-body>
                                <fo:table-row background-color="lightgray">
                                    ...
                                    <fo:table-cell width="60mm" border-style="solid" border-width="1pt" text-align="center" >
                                        <fo:block>Lundi</fo:block>
                                        <fo:block>13/01</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell width="60mm" border-style="solid" border-width="1pt" text-align="center">
                                        <fo:block>Mardi</fo:block>
                                        <fo:block>14/01</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell width="60mm" border-style="solid" border-width="1pt" text-align="center" >
                                        <fo:block>Mercredi</fo:block>
                                        <fo:block>15/01</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell width="60mm" border-style="solid" border-width="1pt" text-align="center">
                                        <fo:block>Jeudi</fo:block>
                                        <fo:block>16/01</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell width="60mm" border-style="solid" border-width="1pt" text-align="center">
                                        <fo:block>Vendredi</fo:block>
                                        <fo:block>17/01</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell width="60mm" border-style="solid" border-width="1pt" text-align="center">
                                        <fo:block>Samedi</fo:block>
                                        <fo:block>18/01</fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                ...
                                <fo:table-row height="4mm">
                                    ...
                                    <fo:table-cell width="40mm" border-style="solid" border-width="1pt" text-align="center" number-rows-spanned="5" background-color="white">
                                        <fo:block font-weight="bold">
                                            <xsl:value-of select="//semaine[1]/mardi/séance[4]/module"/>
                                        </fo:block>
                                        <fo:block  font-size="10pt">
                                            <xsl:value-of select="//semaine[1]/mardi/séance[4]/Professeur"/>
                                        </fo:block>
                                        <fo:block  font-size="10pt">
                                            Salle: <xsl:value-of select="//semaine[1]/mardi/séance[4]/salle"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell width="40mm" border-style="solid" border-width="1pt" text-align="center" number-rows-spanned="5" background-color="white">
                                        <fo:block font-weight="bold">
